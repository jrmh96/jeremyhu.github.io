  ...
  return {
    ...
    template: `<div class="header">
      ...
      <div class="header-icons">
        <span ng-if="website" class="md-subhead page-subhead"><a target="_blank" href="http://jrmh96.github.io" style="color:black"><i class="fa fa-lg fa-code"></i>{{website}}</a></span>
        <span ng-if="email" class="md-subhead page-subhead"><a target="_blank" href="mailto:jrmh96@gmail.com" style="color:black;"><i class="fa fa-lg fa-envelope"></i>{{email}}</a></span>
        <span ng-if="github" class="md-subhead page-subhead"><a target="_blank" href="https://github.com/jrmh96" style="color:black;"><i class="fa fa-lg fa-github"></i>{{github}}</a></span>
        <span ng-if="linkedin" class="md-subhead page-subhead"><a md-theme="default" target="_blank" href="https://www.linkedin.com/in/jeremy-hu-67963610a/" style="color:black;"><i class="fa fa-lg fa-linkedin-square"></i>{{linkedin}}</a></span>
      </div>
    </div>`
  }
})
...
.directive('skillItem', function() {
  return {
    ...
    transclude: true,
    template: `<div class="category">
        <h2 class="category-title md-body-2"><strong>Languages: </strong><b>Fluency: </b>{{flanguages}}
        <b>Proficiency: </b>{{planguages}}</h2>&nbsp;
        <br>
